...
const stats = [
  ...
  { icon: BookOpen, label: "Q1 Publications", value: "Multiple" },
  { icon: Users, label: "Researchers Helped", value: "100+" },
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-16">
            {stats.map((stat, index) => (
              <div 
                key={stat.label}
                className="group p-6 bg-card rounded-2xl shadow-soft hover:shadow-elevated transition-all duration-300 hover:-translate-y-1 border border-border/50"
